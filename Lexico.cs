...
namespace ASM
{
    public class Lexico : Token, IDisposable
    {
        ...
        public Lexico(string nombreArchivo = "prueba.cpp")
        {
            //Primero tengo que verificar la extencion .cpp del nombre del archivo (nombreArchivo)
            //ya que se verifico la extencion, Verificar que el archivo exista,  
            // hacer un if anidado para todo lo anterior dich.
